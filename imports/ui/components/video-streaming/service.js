...
class VideoStreamService {
  ...
  meetingName() {
    return ActionsBarService.meetingName();
  }
...
export default {
  exitVideo: () => videoStreamService.exitVideo(),
  exitingVideo: () => videoStreamService.exitingVideo(),
  exitedVideo: () => videoStreamService.exitedVideo(),
  webcamsLocked: () => videoStreamService.webcamsLocked(),
  webcamOnlyModerator: () => videoStreamService.webcamOnlyModerator(),
  isSharing: () => videoStreamService.isSharing,
  isConnected: () => videoStreamService.isConnected,
  isWaitingResponse: () => videoStreamService.isWaitingResponse,
  joinVideo: () => videoStreamService.joinVideo(),
  joiningVideo: () => videoStreamService.joiningVideo(),
  joinedVideo: () => videoStreamService.joinedVideo(),
  sendUserShareWebcam: stream => videoStreamService.sendUserShareWebcam(stream),
  sendUserUnshareWebcam: stream => videoStreamService.sendUserUnshareWebcam(stream),
  meetingId: () => videoStreamService.meetingId(),
  meetingName: () => videoStreamService.meetingName(),
  getAllWebcamUsers: () => videoStreamService.getAllWebcamUsers(),
