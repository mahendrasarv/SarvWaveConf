...
import { sytle } from './custom.css';
// import UploadsButton from '/imports/ui/components/chat/shared-document/upload-button/component';
...
class PresentationUploader extends Component {
  ...
  renderPresentationList() {
      const { presentations } = this.state;
      const { intl, amIPresenter } = this.props;

      const presentationsSorted = presentations
        .sort((a, b) => a.uploadTimestamp - b.uploadTimestamp);

      return (
        <div className={styles.fileList,"shared-doc"}>
    ...
    return (
      ...
      >
        <td className={styles.tableItemIcon}>
          <FontAwesomeIcon className="file-icon" icon={['fas', 'file']} />
        </td>
        {
          isActualCurrent
            ? (
  ...
  render() {
    ...
    return (
      <div>
        ...
        {(amIPresenter) ? <div className="docuemnt_uploader">
          {isMobileBrowser ? this.renderPicDropzone() : this.renderDropzone()}

        </div> : null}

        {(amIPresenter) ?
          <UploadButton
            className="docuemnt_list"
